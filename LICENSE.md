...
**The present object remains itself while measurable physical consequences are read backward to infer and digitally render possible prior states; the repository does not claim physical time reversal, direct access to a past moment, or empirically confirmed exact reconstruction.**
